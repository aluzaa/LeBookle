                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-6">
                            <div class="page-header-content page-header-st2-content">
                                <h2 class="page-header-title">Wawasan di Balik Lembar</h2>
                                <p class="page-header-desc">Temukan berbagai artikel dari buku bekas, penulis legendaris, dan sastra, yang membawa Anda lebih dekat dengan dunia literasi.</p>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="blog-slide-thumb">
                                <img src="assets/images/photos/111.png" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title text-center">
                                ...
                                <p>Jangan lewatkan informasi berharga ini untuk memperkaya pengalaman membaca Anda!</p>
                            </div>
                        </div>
                    </div>
                    <?php
// Ambil data blog dari tabel
$sql = "SELECT id, title, cover_image FROM blog ORDER BY created_at DESC";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo '<div class="row mb-n9">';
    while ($row = $result->fetch_assoc()) {
        ?>
        <div class="col-sm-4 col-lg-4 mb-8">
            <!--== Start Blog Item ==-->
            <div class="post-item">
                <a href="blog-details.php?id=<?= $row['id']; ?>" class="thumb">
                    <img src="../Admin/<?= htmlspecialchars($row['cover_image']); ?>" width="370" height="320" alt="<?= htmlspecialchars($row['title']); ?>">
                </a>
                <div class="content">
                    <h4 class="title">
                        <a href="blog-details.php?id=<?= $row['id']; ?>"><?= htmlspecialchars($row['title']); ?></a>
                    </h4>
                </div>
            </div>
            <!--== End Blog Item ==-->
    ...
    echo "<p>Tidak ada artikel blog untuk ditampilkan.</p>";
}
?>
