                    ...
                    <div class="col-lg-7 col-xl-7 d-none d-lg-block">
                        <div class="header-navigation ps-7">
                            <ul class="main-nav justify-content-start">
                                <li class="has-submenu"><a href="index-guest.php">Beranda</a>
                                </li>
                    ...
                    <div class="row g-3 g-sm-6">
                        ...
                        <div class="col-6 col-lg-4 col-lg-2 col-xl-2">
                            ...
                            <a href="product.php" class="product-category-item" data-bg-color="#F8DCAF">
                                ...
                                <span data-bg-color="#AE1B18" class="flag-new">baru</span>
                            </a>
                            <!--== End Product Category Item ==-->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title text-center">
                                ...
                                <p>Temukan buku bekas paling populer di toko kami dan temukan bacaan favorit Anda dengan harga terjangkau</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php">
                                        <img src="assets/images/shop/1.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">baru</span>
                                ...
                                <div class="product-info">
                                    <div class="product-rating">
                                        ...
                                        <div class="reviews">150 ulasan</div>
                                    </div>
                                    <h4 class="title"><a href="product-details.php">Orang Gagal</a></h4>
                                    <div class="prices">
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php">
                                        <img src="assets/images/shop/2.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">baru</span>
                                    <div class="product-action">
                                        <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php">Hujan Bulan Juni</a></h4>
                                    <div class="prices">
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php">
                                        <img src="assets/images/shop/3.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">baru</span>
                                    <div class="product-action">
                                        <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php">Crime and Punishment</a></h4>
                                    <div class="prices">
                                        <span class="price">Rp 62.500</span>
                                    </div>
                                </div>
                            </div>
                            <!--== End prPduct Item ==-->
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php">
                                        <img src="assets/images/shop/4.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">baru</span>
                                    <div class="product-action">
                                        <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php">Anna Karenina</a></h4>
                                    <div class="prices">
                                        <span class="price">Rp 77.500</span>
                                    </div>
                                </div>
                            </div>
                            <!--== End prPduct Item ==-->
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php">
                                        <img src="assets/images/shop/5.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">baru</span>
                                    <div class="product-action">
                                        <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php">Botchan</a></h4>
                                    <div class="prices">
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-9">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php">
                                        <img src="assets/images/shop/6.png" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">baru</span>
                                    <div class="product-action">
                                        <button type="button" class="product-action-btn action-btn-quick-view" data-bs-toggle="modal" data-bs-target="#action-QuickViewModal">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php">Belenggu</a></h4>
                                    <div class="prices">
                ...
                <div class="container">
                    ...
                    <div class="row mb-n9">
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.php" class="thumb">
                                    <img src="assets/images/blog/1.jpg" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                                    <h4 class="title"><a href="blog-details.php">Mengenal Buku Bekas: Mengapa Mereka Tetap Menarik?</a></h4>
                                </div>
                            </div>
                            <!--== End Blog Item ==-->
                        </div>
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.php" class="thumb">
                                    <img src="assets/images/blog/3.jpg" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                                    <h4 class="title"><a href="blog-details.php">Panduan Membeli Buku Bekas Online: Tips Mendapatkan Penawaran Terbaik dan Aman.</a></h4>
                                </div>
                            </div>
                            <!--== End Blog Item ==-->
                        </div>
                        <div class="col-sm-6 col-lg-4 mb-8">
                            ...
                            <div class="post-item">
                                <a href="blog-details.php" class="thumb">
                                    <img src="assets/images/blog/2.jpg" width="370" height="320" alt="Image-HasTech">
                                </a>
                                <div class="content">
                                    <h4 class="title"><a href="blog-details.php">Sejarah Pasar Buku Wilis: Surga Buku Bekas di Malang.</a></h4>
                                </div>
                            </div>
                            <!--== End Blog Item ==-->
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="widget-item">
                                <div class="widget-about">
                                    <a class="widget-logo" href="index-guest.php">
                    ...
                    <div class="search-box-form-wrap">
                        <form action="#" method="post">
                            <div class="aside-search-form position-relative">
                                ...
                                <input id="SearchInput" type="search" class="form-control" placeholder="Cari judul buku atau nama penulis...">
            ...
            <div class="offcanvas-body">
                <div id="offcanvasNav" class="offcanvas-menu-nav">
                    <ul>
                        ...
                        <li class="has-submenu"><a href="#">Halaman</a>
                            <ul class="submenu-nav">
                                <li><a href="account-login.php">Akun Saya</a></li>
                                <li><a href="product-cart.php">Keranjang</a></li>
                                <li><a href="product-wishlist.php">Daftar Keinginan</a></li>
                                <li><a href="product-compare.php">Status Pesanan</a></li>
                                <li><a href="faq.php">Halaman FAQs</a></li>
