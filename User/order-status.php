...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="page-header-st3-content text-center text-md-start">
                            <h2 class="page-header-title">Status Pesanan</h2>
                            <p class="m-0">Lacak status pesanan Anda secara real-time.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--== End Page Header Area Wrapper ==-->
            ...
            <div class="container px-1 px-md-4 py-5 mx-auto">
                <div class="card">
                    <div class="row-stat d-flex justify-content-between px-3 top">
                        <div class="d-flex">
                    ...
                    <div class="row-stat d-flex justify-content-center">
                        <div class="col-12">
                    ...
                    <div class="row-stat justify-content-between top" style="width: 90%;">
                        <div class="row-stat d-flex icon-content">
