                ...
                <div class="container">
                    <div class="row flex-xl-row-reverse">
                        <div class="col-lg-6 col-xl-7">
                            <div class="faq-thumb">
                                <img src="assets/images/photos/333.png" width="601" height="368" alt="Image">
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-5">
                            <div class="faq-content">
                                ...
                                <p class="faq-desc">Temukan jawaban atas pertanyaan umum tentang pemesanan, pengiriman, dan pembayaran di sini. Jika Anda tidak menemukan informasi yang Anda butuhkan, jangan ragu untuk menghubungi kami!</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading1">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                            Apa itu Pasar Buku Wilis?
                                        </button>
                                    </h2>
                                    <div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="heading1" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Pasar Buku Wilis adalah pasar buku bekas yang terletak di Malang, Indonesia. Di sini, Anda dapat menemukan berbagai jenis buku dengan harga terjangkau.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading2">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                            Bagaimana cara membeli buku bekas di website ini?
                                        </button>
                                    </h2>
                                    <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Anda dapat membeli buku dengan menambahkan buku ke keranjang belanja dan mengikuti langkah-langkah pembayaran di website kami.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading3">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                            Apakah buku bekas yang dijual berkualitas?
                                        </button>
                                    </h2>
                                    <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="heading3" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Ya, kami memastikan bahwa semua buku bekas yang dijual dalam kondisi baik. Kami memberikan deskripsi dan foto untuk setiap buku agar Anda tahu apa yang Anda beli.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading4">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                                            Apakah ada jaminan uang kembali jika buku tidak sesuai harapan?
                                        </button>
                                    </h2>
                                    <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Ya, kami menawarkan jaminan uang kembali jika buku yang Anda terima tidak sesuai dengan deskripsi. Silakan hubungi kami dalam waktu 7 hari setelah menerima buku.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading5">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                            Apakah saya bisa menjual buku bekas di website ini?
                                        </button>
                                    </h2>
                                    <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Ya, kami menerima buku bekas dari penjual. Anda dapat menghubungi kami melalui halaman kontak untuk informasi lebih lanjut tentang cara menjual buku Anda.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Anda dapat melakukan pembayaran melalui transfer bank, Gopay, OVO, atau DANA. Pastikan untuk mengikuti instruksi yang diberikan saat checkout.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading7">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
                                            Apakah saya perlu mengupload bukti pembayaran?
                                        </button>
                                    </h2>
                                    <div id="collapse7" class="accordion-collapse collapse" aria-labelledby="heading7" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Ya, Anda perlu mengupload bukti pembayaran setelah melakukan transaksi untuk mempercepat proses verifikasi dan pengiriman buku.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading8">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse8" aria-expanded="false" aria-controls="collapse8">
                                            Di mana saya bisa menemukan buku-buku langka?
                                        </button>
                                    </h2>
                                    <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8" data-bs-parent="#FaqAccordion">
                                        <div class="accordion-body">
                                            <p>Anda dapat menemukan buku-buku langka di Pasar Buku Wilis dan di bagian koleksi khusus di website kami. Kami juga menyarankan untuk terus memeriksa update kami secara berkala.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
