...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
        ...
        <!--== End Header Wrapper ==-->
        <section class="page-header-area page-header-style2-area">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-md-6">
                        <div class="page-header-content page-header-st2-content">
                            <h2 class="page-header-title">Surga Buku Bekas Kota Malang</h2>
                            <p class="page-header-desc">Di antara tumpukan buku, tersembunyi harta yang hanya menunggu untuk ditemukan oleh mereka yang mengerti nilai dari setiap kata.</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="blog-slide-thumb">
                            <img src="assets/images/photos/222.png" alt="Image">
                        </div>
                    </div>
                </div>
            </div><br><br>
        ...
        <section class="about-content">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                          <h2><span>Pasar Buku Wilis:</span> Harta Karun di Tengah Kota</h2>
                <h5>Selamat datang di Pasar Buku Wilis, tempat di mana buku bekas berkualitas dan cerita bertemu.</h5>
                    </div>
                    <!-- end col-12 -->
                     <div class="col-lg-7">
                <p>Sejak didirikan, Pasar Buku Wilis telah menjadi tempat berkumpulnya para pencinta literasi. Dengan koleksi yang beragam, dari fiksi klasik hingga referensi akademis, kami berkomitmen untuk membantu pengunjung menemukan buku yang sesuai dengan selera mereka. Kami bangga menjadi bagian dari komunitas literasi di Indonesia, menciptakan ruang di mana setiap orang dapat menemukan buku impian mereka.</p>
              </div>
              <!-- en col-7 -->
              <div class="col-lg-5">
                <p>Sebagai pusat buku bekas yang terkemuka di Malang, kami menyediakan beragam karya sastra dari penulis legendaris dan buku langka, membawa Anda lebih dekat ke dunia literasi.</p>
              </div>
              <!-- end col-5 -->

                <div class="map-area">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15805.142679116532!2d112.6174635!3d-7.9694006!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78828245091c15%3A0x3ada54d48d01dee1!2sPasar%20Buku%20Wilis!5e0!3m2!1sid!2sid!4v1726906798231!5m2!1sid!2sid" width="600" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div> 

               <!-- end col-12 -->
               <div class="col-md-6"><br><br>
                <h6>Spesifikasi Buku di Pasar Kami</h6>
                   <ul>
                    <li>Koleksi langka dari sastra klasik hingga karya internasional terkenal.</li>
                    <li>Buku dalam kondisi baik dan siap untuk dibaca.</li>
                    <li>Harga terjangkau, tanpa mengorbankan kualitas.</li>
                    <li>Tersedia buku pelajaran, fiksi, referensi, dan biografi.</li>
                    <li>Pembelian bisa dilakukan secara langsung atau melalui platform online.</li>
                </ul>
               </div>
               <!-- end col-6 -->
               <div class="col-md-6"><br><br>
                <h6>Manfaat Membeli Buku Bekas</h6>
                   <ul>
                    <li>Nostalgia: Setiap buku menyimpan kisah dari pemilik sebelumnya.</li>
                    <li>Keberlanjutan: Membeli buku bekas mendukung pengurangan limbah.</li>
                    <li>Harga Terjangkau: Temukan buku berkualitas dengan harga murah.</li>
                    <li>Pilihan Beragam: Koleksi kami memenuhi kebutuhan berbagai kalangan dan minat.</li>
                </ul>
               </div>
               <!-- end col-6 -->
               <div class="col-lg-12">
                <div class="video-content" style="display: flex; justify-content: center; align-items: center;">
                  <iframe width="720" height="450" src="https://www.youtube.com/embed/zAbEocXu9sM?autoplay=0&mute=0&controls=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <!-- end video-content -->
              </div>
               ...
               <div class="col-12">
                <blockquote style="display: flex; justify-content: center; align-items: center;">
                    <p>Melalui layar ini, jelajahi jejak langkah para pencinta buku yang membangun kisah di setiap sudut Pasar Buku Wilis.</p>
                </blockquote>
               
                <p>Pasar Buku Wilis adalah oase di tengah hiruk-pikuk zaman digital, menghubungkan nostalgia dengan keabadian. Setiap buku di sini menyimpan jejak tangan-tangan terdahulu, mencatat kisah dari masa lalu yang siap dibuka kembali. Lebih dari sekadar literatur, setiap buku menghadirkan perjalanan melintasi waktu, menghubungkan berbagai era, budaya, dan cerita dari berbagai sudut dunia. Membeli buku di sini seperti membuka jendela ke masa lalu dan masa depan sekaligus, di mana lembar-lembar usang menyimpan kisah yang menunggu untuk dilanjutkan, menghadirkan inspirasi dan makna bagi setiap pembaca.</p>
                <p>Kami mengundang Anda untuk menjelajahi koleksi kami yang kaya, menemukan buku bekas yang bermakna, dan menikmati atmosfer hangat Pasar Buku Wilis. Setiap buku di sini bagaikan pintu yang terbuka, menuntun Anda menuju dunia baru yang menanti untuk dijelajahi.</p>
              </div>
              <!-- en col-12 -->
                </div>
                <!-- end row -->
