                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="page-header-st3-content text-center text-md-start">
                                <h2 class="page-header-title">Daftar Keinginan</h2>
                                <p class="m-0">Buku-buku yang sedang Anda pertimbangkan untuk dikoleksi.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="product-stock-status">Status Stok</th>
                                ...
                                <tbody>
                                    <tr class="tbody-item">
                                        ...
                                        <td class="product-stock-status">
                                            <span class="wishlist-in-stock">Tersedia</span>
                                        </td>
                                        <td class="product-add-to-cart">
                                            <a class="btn-shop-cart" href="product-cart.php">Tambah ke Keranjang</a>
                                        </td>
                                    </tr>
                                    <tr class="tbody-item">
                                        <td class="product-remove">
