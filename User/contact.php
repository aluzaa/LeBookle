            ...
            <section class="contact-area">
                <div class="container">
                    <div class="row">
                        <!--== Map Area ==-->
                        <div class="col-lg-6">
                            <div class="con-map-area">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15804.352560910644!2d112.6273107!3d-7.9898343!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd6281b75ea5485%3A0x90fd5c6fcedf6acf!2sSMK%20Negeri%204%20Kota%20Malang!5e0!3m2!1sid!2sid!4v1726909937181!5m2!1sid!2sid" 
                        ...
                        <div class="col-lg-6">
                            <div class="section-title position-relative">
                                ...
                                <p class="m-0">Punya pertanyaan atau ingin tahu lebih banyak tentang koleksi buku kami? Jangan ragu untuk mengirim pesan—kami siap mendengar dari Anda!</p>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="con_name" placeholder="Nama Depan">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input class="form-control" type="email" name="con_email" placeholder="Alamat Email">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <textarea class="form-control" name="con_message" placeholder="Pesan"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                <button class="btn btn-sm" type="submit">KIRIM</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
              ...
              <div class="inner wow fadeIn">
                <div class="row">
                  <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.05s">
                    <figure><img src="assets/images/footer-icon01.png" alt="Image"></figure>
                    <h3 style="color: #fff;">Alamat</h3>
                    <p>Jl. Tanimbar No.22, Kasin, Kec. Klojen, Kota Malang, Jawa Timur</p>
                  </div>
                  <!-- end col-4 -->
                  <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.10s">
                    <figure><img src="assets/images/footer-icon02.png" alt="Image"></figure>
                    <h3 style="color: #fff;">Jam Kerja</h3>
                    <p>Senin sampai Jumat <br>dari <strong>09:00</strong> hingga <strong>17:00</strong> <br>
                  </div>
                  <!-- end col-4 -->
                  <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.15s">
                    <figure><img src="assets/images/footer-icon03.png" alt="Image"></figure>
                    <h3 style="color: #fff;">Layanan Pelanggan</h3>
                    <p>+62 000-3344-2211<br>
                      asdfghjklxx@gmail.com</p>
                  </div>
                  <!-- end col-4 --> 
                </div>
                <!-- end row --> 
