            ...
            <div class="col-lg-4">
                <div class="card card-transparent card-block card-stretch card-height border-none">
                    <div class="card-body p-0 mt-lg-2 mt-0">
                        <h3 class="mb-3">Hi Graham, Selamat Pagi</h3>
                        <p class="mb-0 mr-4"> 
                            Dashboard Anda memberi Anda tampilan kinerja utama atau proses bisnis.
                            </p>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="list-unstyled row top-product mb-0">
                                ...
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="img-rounded">
                                            <img src="assets/images/product/new/1.png" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Orang Gagal</h5>
                            ...
                            <li class="col-lg-3">
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="img-rounded">
                                            <img src="assets/images/product/new/2.png" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Hujan Bulan Juni</h5>
                            ...
                            <li class="col-lg-3">
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="img-rounded">
                                            <img src="assets/images/product/new/3.png" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Crime and Punishment</h5>
                            ...
                            <li class="col-lg-3">
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="img-rounded">
                                            <img src="assets/images/product/new/6.png" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">Belenggu</h5>
            ...
            <div class="col-lg-4">  
                <div class="card card-transparent card-block card-stretch mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between p-0">
                        <div class="header-title">
                            <h4 class="card-title mb-0">Produk Terbaik Sepanjang Masa</h4>
                        </div>
                        <div class="card-header-toolbar d-flex align-items-center">
                ...
                <div class="card card-block card-stretch card-height-helf">
                    <div class="card-body card-item-right">
                        <div class="d-flex align-items-top">
                            <div class="img-rounded">
                            <img src="assets/images/product/new/4.png" class="style-img img-fluid m-auto" alt="image" style="max-width: 120px; height: auto;">
                            </div>
                            <div class="style-text text-left">
                                <h5 class="mb-2">Anna Karenina</h5>
                                <p class="mb-2">Total Dijual : 45897</p>
                                <p class="mb-0">Total Pendapatan : $45,89 M</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card card-block card-stretch card-height-helf">
                    <div class="card-body card-item-right">
                        <div class="d-flex align-items-top">
                            <div class="img-rounded">
                            <img src="assets/images/product/new/5.png" class="style-img img-fluid m-auto" alt="image" style="max-width: 120px; height: auto;">
                            </div>
                            <div class="style-text text-left">
                                <h5 class="mb-2">Botchan</h5>
                                <p class="mb-2">Total Dijual : 44359</p>
                                <p class="mb-0">Total Pendapatan : $45,50 M</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-flex flex-wrap align-items-center mt-2">
                            ...
                            <div class="d-flex align-items-center ml-5 progress-order-right">
                                ...
                                <div class="progress-value ml-3">
                                    <h5>$59,8478</h5>
                                    <p class="mb-0">Pesanan Terbaik</p>
                                </div>
                            </div>
                        </div>
                    </div>
