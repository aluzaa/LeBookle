...
$sql = "SELECT c.user_id, c.fullname, c.address, c.city, c.state, c.postal_code, c.phone, c.country, c.created_at, u.username
        FROM customer c
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="user-list-files d-flex">
                    <a href="page-add-customer.php" class="btn btn-primary add-list mr-2"><i class="las la-plus mr-2"></i>Tambah Pelanggan</a>
    ...
    <table id="user-list-table" class="table table-striped dataTable mt-4" role="grid" aria-describedby="user-list-page-info">
        <thead>
            <tr class="ligth">
                ...
                <th>Nama Lengkap<i class="sort-icon"></i></th>
                <th>Alamat<i class="sort-icon"></i></th>
                <th>Nomor Telepon<i class="sort-icon"></i></th>
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex align-items-center list-user-action">
                                <a class="btn btn-sm bg-primary view-customer-btn" 
                                    data-toggle="tooltip" 
                                    data-placement="top" 
                                    title="View" 
                                ...
                                <a class="btn btn-sm bg-success" data-bs-toggle="modal" data-bs-target="#editCustomerModal" 
                                    data-id="<?php echo $row['user_id']; ?>" 
                                    ...
                                    data-postal_code="<?php echo htmlspecialchars($row['postal_code']); ?>" 
                                    data-country="<?php echo htmlspecialchars($row['country']); ?>" 
                                    data-phone="<?php echo htmlspecialchars($row['phone']); ?>">
                                    <i class="ri-pencil-line mr-0"></i>
                                </a>
                                <a href="javascript:void(0);" 
                                   class="btn btn-sm bg-warning delete-user" 
                                   data-id="<?php echo $row['user_id']; ?>" 
                                   title="Delete">
            ...
            <?php else: ?>
                <tr>
                    <td colspan="9">Tidak ada pengguna yang ditemukan.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="customerDetails">
                <!-- Detail pelanggan akan dimuat di sini melalui AJAX -->
...
<div class="modal fade" id="editCustomerModal" tabindex="-1" aria-labelledby="editCustomerModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="editCustomerForm" action="update_customer.php" method="POST">
...
<script>
    ...
    document.querySelectorAll('.view-customer-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            fetch(`view_customer.php?id=${customerId}`)
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editCustomerModal.addEventListener('show.bs.modal', function (event) {
        ...
        console.log(userId, fullname, address, city, state, postalCode, country, phone);

        // Fill the modal form with the values
        editCustomerModal.querySelector('#edit-user-id').value = userId;
        editCustomerModal.querySelector('#edit-fullname').value = fullname;
        editCustomerModal.querySelector('#edit-address').value = address;
        editCustomerModal.querySelector('#edit-city').value = city;
        editCustomerModal.querySelector('#edit-state').value = state;
        editCustomerModal.querySelector('#edit-postal-code').value = postalCode;
        editCustomerModal.querySelector('#edit-country').value = country;
        editCustomerModal.querySelector('#edit-phone').value = phone;
    });
});
