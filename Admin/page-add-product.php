...
// Proses form untuk menambah buku
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = $conn->prepare("INSERT INTO books (judul, penulis, penerbit, tahun_terbit, genre, halaman, berat, sinopsis, kondisi, price, stock, created_at, kategori, isbn, cover) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?, ?, ?)");
    ...
    $sql->bind_param(
        "sssssiissdssss", // 13 parameters with proper types
        $judul, 
        $penulis, 
        $penerbit, 
        $tahun_terbit, 
    ...
    if ($sql->execute()) {
        // Redirect ke page-list-product.php jika berhasil
...
<html lang="en">
    ...
    <div class="card-body">
        <form action="page-add-product.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="genre" class="form-control">
                    ...
                    <option value="thriller/misteri">Thriller/Misteri</option>
                    <option value="komedi">Komedi</option>
                    <option value="biografi">Biografi</option>
                    <option value="pendidikan kesehatan">Pendidikan</option>
