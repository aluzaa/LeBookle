...
$sql = "SELECT id, username, email, password_hash, google_id, role, created_at FROM users";
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="user-list-files d-flex">
                    <a href="page-add-user.php" class="btn btn-primary add-list mr-2"><i class="las la-plus mr-2"></i>Tambah Pengguna</a>
    ...
    <table id="user-list-table" class="table table-striped dataTable mt-4" role="grid" aria-describedby="user-list-page-info">
        <thead>
            <tr class="ligth">
                ...
                <th>Role<i class="sort-icon"></i></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex align-items-center list-user-action">
                                <a class="btn btn-sm bg-primary view-user-btn" 
                                   data-toggle="tooltip" 
                                   data-placement="top" 
                                   title="View" 
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
    // Menambahkan event listener pada semua tombol dengan kelas delete-user
    document.querySelectorAll('.delete-user').forEach(function(button) {
        button.addEventListener('click', function() {
            var userId = this.getAttribute('data-id'); // Ambil ID user dari atribut data-id
            ...
            if (confirm('Apakah Anda yakin ingin menghapus user ini?')) {
                ...
                fetch('delete_user.php', {
                    ...
                    body: 'id=' + encodeURIComponent(userId) // Kirim ID sebagai data POST
                })
